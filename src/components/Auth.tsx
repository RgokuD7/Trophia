    ...
    <div className="flex flex-col h-full bg-[#0d0e15] px-6 py-12 justify-between items-center relative overflow-hidden">
      ...
      <div className="w-full space-y-5 z-10 mb-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center space-x-3 py-3.5 px-4 rounded-xl bg-white text-gray-900 font-bold hover:bg-gray-100 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-white/5 disabled:opacity-75 disabled:scale-100"
        >
          {loading ? (
